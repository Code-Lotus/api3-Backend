...
export default class CreateUsuarioController {
    async handle(request: FastifyRequest, reply: FastifyReply) {
        const { usuario_nome, usuario_cpf, usuario_email, usuario_senha, administrador } = request.body as { usuario_nome: string, usuario_cpf: string, usuario_email: string, usuario_senha: string, administrador: string }
